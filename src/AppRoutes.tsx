...
// Quartiers de Tanger
import NeighborhoodMalabata from "./pages/NeighborhoodMalabata";
...
const AppRoutes = () => (
  <Routes>
    ...
    {/* Quartiers de Tanger */}
    <Route path="/ambulance-tanger-malabata" element={<NeighborhoodMalabata />} />
    ...
    {cities.map((city) => (
      <Route
        ...
        element={
          city.slug === 'rabat' ? <RabatPage /> : 
          city.slug === 'tanger' ? <TangerPage /> : 
          <CityPage />
        }
      />
    ))}
